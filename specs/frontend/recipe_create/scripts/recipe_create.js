...
function createPanelContainer(recipeCreatePanelContainer) {
    ...
    .recipe-save-btn:hover, .recipe-browse-btn:hover {
        background-color: #FDE79B;
        color: #405263;
        font-weight: bold;
    }
    
    .recipe-save-btn:focus, .recipe-browse-btn:focus {
        background-color: #405263;
        color:white
    }
    ...
    #recipe-chief-name-input, #recipe-time-input, #recipe-servings-input, .ingred-quantity {
        margin-left: 1vw;
        width: 70%;
    }
    ...
    .add-steps-ingred-btn {
        background-color: transparent;
        border: 0px;
        display: flex;
    }
    
    #add-step-ingred-icon {
        font-size: 2vw;
    }
    
    .add-step-ingred-text {
        padding: 1.2% 0 0 0;
        font-size: 16px;
        margin-bottom: auto;
    }
