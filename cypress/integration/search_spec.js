...
describe('EggCellent E2E Test', function () {
  ...
  it('Search vodka by Ingredients', () => {
    ...
    cy.get('[class="result-text"]').should(
      'have.text',
      'Search By Categories: 21 Results'
    );
    cy.contains('Contact Us').should('be.visible');
  });
  ...
  it('Search 10 by Cooking Time', () => {
    ...
    cy.get('[class="result-text"]').should(
      'have.text',
      'Search By Categories: 72 Results'
    );
    cy.contains('Contact Us').should('be.visible');
  });
  ...
  it('Search 5 by Cooking Time', () => {
    ...
    cy.get('[class="result-text"]').should(
      'have.text',
      'Search By Categories: 35 Results'
    );
    cy.contains('Contact Us').should('be.visible');
  });
  ...
  it('Search 10 by Calories', () => {
    ...
    cy.get('[class="result-text"]').should(
      'have.text',
      'Search By Categories: 6 Results'
    );
    cy.contains('Contact Us').should('be.visible');
  });
