...
function changeColor1() {
  ...
  if (counter1 % 2 == 0) {
    but.style.backgroundColor = '#FBE598';
    but.style.color = '#405262';
  } else {
    but.style.backgroundColor = '#405262';
...
function show() {
  ...
  mainpage.style.marginLeft = '245px';
}
...
function display() {
  let tagElem = document.getElementById('offcanvasWithBackdrop');
  let tagTab = new bootstrap.Offcanvas(tagElem);
  tagTab.show();
}
function hide() {
  let tagElem = document.getElementById('offcanvasWithBackdrop');
